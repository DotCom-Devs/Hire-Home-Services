...
class PestcontrolProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = PestcontrolProfile
        fields = ['company_name','phone','city','area','address','charges','profile_pic','timeopen','timeclose','is_avaliable']
...
class pestcontrolFilter(forms.Form):
