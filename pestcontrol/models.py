...
class PestcontrolProfile(models.Model):
    user = models.OneToOneField(User,on_delete=models.CASCADE,related_name = 'pestcontrol')
    company_name = models.CharField(max_length=150,default='Individual')
